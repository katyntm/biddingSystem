...
namespace CarAuction.Infrastructure.Migrations
{
    ...
    [Migration("20250813033710_addHashLog")]
    partial class addHashLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarAuction.Domain.Entities.CriteriaHashLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CarAuction.Domain.Entities.StepHashLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CarAuction.Domain.Entities.TacticHashLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CarAuction.Domain.Entities.CriteriaHashLog", b =>
                {
                    b.HasOne("CarAuction.Domain.Entities.Criteria", null)
                        .WithOne()
                        .HasForeignKey("CarAuction.Domain.Entities.CriteriaHashLog", "CriteriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CarAuction.Domain.Entities.StepHashLog", b =>
                {
                    b.HasOne("CarAuction.Domain.Entities.Step", null)
                        .WithOne()
                        .HasForeignKey("CarAuction.Domain.Entities.StepHashLog", "StepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CarAuction.Domain.Entities.TacticHashLog", b =>
                {
                    b.HasOne("CarAuction.Domain.Entities.Tactic", null)
                        .WithOne()
                        .HasForeignKey("CarAuction.Domain.Entities.TacticHashLog", "TacticId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
