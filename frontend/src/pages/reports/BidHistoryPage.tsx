...
import {  formatCurrency, formatDateTime, getStatusVariant } from "../../shared/utils/format";
                ...
                <tbody>
                  {bidReports.map((report) => (
                    <tr key={report.id}>
                      ...
                      <td>
                        <strong className="text-info">{formatCurrency(report.bidAmount)}</strong>
                      </td>
                      <td>{report.currentHighestBid && <strong className="text-success">{formatCurrency(report.currentHighestBid)}</strong>}</td>
                      <td>{formatDateTime(report.bidDate)}</td>
                      <td>
